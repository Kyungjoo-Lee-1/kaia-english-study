      ...
      <main className="max-w-4xl mx-auto px-4 py-10">
          ...
          <div className="space-y-3">
            {ranked.map((member, idx) => {
              ...
              return (
                <div
                  key={member.id}
                  className="bg-white dark:bg-zinc-900 rounded-2xl border border-slate-100 dark:border-zinc-800 p-4"
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-slate-400 dark:text-zinc-500 mt-0.5">미인증 {miss}회</div>
                    </div>
                  </div>
        ...
        <div className="flex items-center gap-4 text-xs text-slate-400 dark:text-zinc-500">
          <span className="flex items-center gap-1.5">
            <span className="w-4 h-4 rounded bg-blue-500 dark:bg-blue-600 inline-block" />
            인증 완료
          </span>
          <span className="flex items-center gap-1.5">
            <span className="w-4 h-4 rounded bg-red-100 dark:bg-red-950 inline-block" />
            미인증 (−{PENALTY_PER_MISS.toLocaleString()}원)
          </span>
        </div>
      </main>
    </div>
